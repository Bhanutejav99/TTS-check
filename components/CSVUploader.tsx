...
const ELEVENLABS_VOICES = [
  ...
  { id: 'ibbx9zDYGvLgtYzRbqqG', name: 'Male 2' },
  { id: 'fEJqMD6Jp1JFP8T1BZpd', name: 'Female 1' },
  { id: 'KrfvGW2D1x6nS5QnRj2q', name: 'Female 2' },
          ...
          <div className="flex flex-col h-full space-y-8">
            ...
            <div className="pt-2 grid grid-cols-2 gap-4">
               <button
                  ...
                  disabled={!canStart}
                  className={`w-full py-5 rounded-full font-bold uppercase text-[10px] tracking-[0.2em] transition-all flex items-center justify-center gap-2
                  ${canStart ? 'bg-white/5 text-white hover:bg-white/10 border border-white/10' : 'bg-transparent text-white/10 border border-white/5 cursor-not-allowed'}`}
               >
              ...
              <button
                ...
                disabled={!canStart}
                className={`w-full py-5 rounded-full font-bold uppercase text-[10px] tracking-[0.2em] transition-all shadow-xl group flex items-center justify-center gap-2
                ${canStart
